...
// Pull apart hank the tank, check which pinouts support the pwm and rewire accordingly
// update the dns settings for death-trap.uk to point to the hankthetank s3 bucket
// update the index.html to also send the distance from center the joystick is at
// now maybe a good time to address if our methoed of updating data is going to pass a stress test
// how do other people do it using sockets?
